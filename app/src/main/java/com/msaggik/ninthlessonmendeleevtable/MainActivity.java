...
public class MainActivity extends AppCompatActivity {
    ...
    private EditText minYearIn, maxYearIn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        minYearIn = findViewById(R.id.minIn);
        maxYearIn = findViewById(R.id.maxIn);
    ...
    private View.OnClickListener listener = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            ...
            if (minYearIn.getText() != null && maxYearIn.getText() != null) {

                // считывание введённых параметров
                minYear = Float.parseFloat(minYearIn.getText().toString());
                maxYear = Float.parseFloat(maxYearIn.getText().toString());
